...
class ClasesControllerTest < ActionController::TestCase
  ...
  test "should create clase" do
    assert_difference('Clase.count') do
      post :create, clase: { genero: @clase.genero, multijugador: @clase.multijugador, plataforma: @clase.plataforma }
    end
  ...
  test "should update clase" do
    patch :update, id: @clase, clase: { genero: @clase.genero, multijugador: @clase.multijugador, plataforma: @clase.plataforma }
    assert_redirected_to clase_path(assigns(:clase))
  end
